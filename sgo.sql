...
CREATE TABLE IF NOT EXISTS expertos_semillas (
    ...
    semilla_id INT NOT NULL,
    competencia_id INT NOT NULL, -- 🔥 Nueva columna mandatoria
    ...
    -- Clave única compuesta para evitar duplicar al mismo experto en la misma competencia de la semilla
    UNIQUE(experto_id, semilla_id, competencia_id)
) ENGINE=InnoDB;
