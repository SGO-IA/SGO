export const generarPromptPedagogico = (etapa, contextoIA, instruccion) => {
  return `
    ...
    3. Do not use emojis, do not use hashtags, do not use hyphens or dashes, and avoid excessive bold text.
    4. Structure the content using only plain text titles. The structure must include: Activity Name, Objective, Duration, Step by step description, Required resources, and Link to the learning outcome.
    ...
    7. Write the entire activity in the target language of the learners, directed towards them.
    8. CRITICAL: Do not mention internal IDs, database records, RAP codes, or technical system data.
    9. CRITICAL: Do not write about the instructor or describe what the instructor does. Create only the content and instructions for the learners. Speak directly to them in the second person (e.g., "Complete this task", "Analyze this case").
  `;
};